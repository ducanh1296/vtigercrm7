<?php /* Smarty version Smarty-3.1.7, created on 2019-11-20 10:00:50
         compiled from "C:\xampp\htdocs\vtigercrm\includes\runtime/../../layouts/v7\modules\Inventory\partials\LineItemsContent.tpl" */ ?>
<?php /*%%SmartyHeaderCode:18119193985dce4be488f727-30690025%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '1fb65c9d8cb02a3be255f21dea88dbb099097786' => 
    array (
      0 => 'C:\\xampp\\htdocs\\vtigercrm\\includes\\runtime/../../layouts/v7\\modules\\Inventory\\partials\\LineItemsContent.tpl',
      1 => 1574244048,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '18119193985dce4be488f727-30690025',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.7',
  'unifunc' => 'content_5dce4be49a1a5',
  'variables' => 
  array (
    'row_no' => 0,
    'entityIdentifier' => 0,
...
<?php if ($_valid && !is_callable('content_5dce4be49a1a5')) {function content_5dce4be49a1a5($_smarty_tpl) {?>
...
" data-module-name="Products" data-field-name="productid"><?php echo Vtiger_Module_Model::getModuleIconPath('Products');?>
</span><?php }?><?php }?></div></div></div></div></div><?php ob_start();?><?php echo $_smarty_tpl->tpl_vars['data']->value[$_smarty_tpl->tpl_vars['hdnProductId']->value];?>
<?php $_tmp3=ob_get_clean();?><?php $_smarty_tpl->tpl_vars['ID'] = new Smarty_variable($_tmp3, null, 0);?><?php $_smarty_tpl->tpl_vars['ID'] = new Smarty_variable((int)$_smarty_tpl->tpl_vars['ID']->value, null, 0);?><input type="hidden" value="<?php echo $_smarty_tpl->tpl_vars['data']->value[$_smarty_tpl->tpl_vars['subproduct_ids']->value];?>
...
" class="subInformation"><span class="subProductsContainer"><?php echo Inventory_Detail_View::check($_smarty_tpl->tpl_vars['ID']->value);?>
...
<?php $_tmp4=ob_get_clean();?><?php echo getProductBaseCurrency($_smarty_tpl->tpl_vars['productId']->value,$_tmp4);?>
